    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('tiket.store') }}" method="POST" multipart enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="basic-default-company">Harga Tiket</label>
                            <input type="number" class="form-control" name="harga_tiket" placeholder="Masukan Harga Tiket" />
                        </div>
