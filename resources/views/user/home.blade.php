...
<head>
    <title>Hetra - Aplikasi Pemesanan Tiket</title>
    <meta charset="utf-8">
...
<body>
    ...
    <header>
        <div class="container-fluid">
            <div class="row py-3 border-bottom">
                ...
                <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-8 d-none d-lg-block">
    ...
    <section class="py-3"
        style="background-image: url({{asset('user/image/banner.jpg')}});background-repeat: no-repeat;background-size: cover;">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="banner-blocks">
                        ...
                        <div class="banner-ad bg-info block-1">
