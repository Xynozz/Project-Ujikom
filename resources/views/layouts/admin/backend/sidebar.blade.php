<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Hetra</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Wisata</span>
        </li>
        <!-- Layouts -->
        <li
            class="menu-item {{ request()->routeIs('kategori.*') || request()->routeIs('wisata.*') ? 'active menu-open' : '' }}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ request()->routeIs('wisata.index') ? 'active' : '' }}">
                    <a href="{{ route('wisata.index') }}" class="menu-link">
                        <div data-i18n="Without navbar">Wisata</div>
                    </a>
                </li>
            </ul>
        </li>

        <li class="menu-item {{ url()->current() == route('ulasan.index') ? 'active' : '' }}">
            <a href="{{  route('ulasan.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-star"></i>
                <div data-i18n="Analytics">Ulasan</div>
            </a>
        </li>
        <li class="menu-item {{ url()->current() == route('tiket.index') ? 'active' : '' }}">
            <a href="{{  route('tiket.index') }}" class="menu-link">
                <i class='menu-icon tf-icons  bx bx-purchase-tag-alt'></i>
                <div data-i18n="Analytics">Tiket</div>
            </a>
        </li>
        <li class="menu-item {{ url()->current() == route('pemesanan.index') ? 'active' : '' }}">
        ...
        <li class="menu-item {{ url()->current() == route('laporan.user') ? 'active' : '' }}">
        ...
        <li class="menu-item {{ url()->current() == route('laporan.pemesanan') ? 'active' : '' }}">
            <a href="{{ route('laporan.pemesanan') }}" class="menu-link">
                ...
                <div data-i18n="Pemesanan">Laporan Pemesanan</div>
            </a>
        </li>
</ul>
</aside>
